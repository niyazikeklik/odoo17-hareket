...
export class AttendanceWebcamDialog extends Component {
    ...
    close() {
        console.log("close attendance web cam dialog");
    ...
    async onClickConfirm(){
        ...
        console.log("close attendance web cam dialog 128");
        this.props.close();
    }
}
AttendanceWebcamDialog.components = { Dialog };
AttendanceWebcamDialog.template = "hr_puantaj.AttendanceWebcamDialog";
